...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    language: 'Language',
    defaultQuestions: [
      'What are the safety requirements for working at height according to our standards?',
      'How do I complete a risk assessment step-by-step?',
      'Can you provide an example of a HACCP validation process?',
      'What are the metal detection calibration requirements?',
      'What PPE is required for chemical handling procedures?',
    ],
    greeting: 'Technical Standards Agent',
    greetingSubtitle: 'AI-powered assistant for technical standards, procedures, and compliance documentation',
    ...
    generateTitle: 'Principle Generator',
    generateSubtitle: 'Create Principle documents that bridge BRC Policy to practical SOPs',
  ...
  pl: {
    ...
    language: 'Język',
    defaultQuestions: [
      'Jakie są wymagania bezpieczeństwa dotyczące pracy na wysokości zgodnie z naszymi standardami?',
      'Jak krok po kroku wypełnić ocenę ryzyka?',
      'Czy możesz podać przykład procesu walidacji HACCP?',
      'Jakie są wymagania dotyczące kalibracji wykrywaczy metali?',
      'Jakie środki ochrony osobistej są wymagane do procedur z chemikaliami?',
    ],
    greeting: 'Agent Standardów Technicznych',
    greetingSubtitle: 'Asystent AI dla standardów technicznych, procedur i dokumentacji zgodności',
    ...
    generateTitle: 'Generator Zasad',
    generateSubtitle: 'Twórz dokumenty Zasad łączące Politykę BRC z praktycznymi SOP',
  ...
  ro: {
    ...
    language: 'Limba',
    defaultQuestions: [
      'Care sunt cerințele de siguranță pentru lucrul la înălțime conform standardelor noastre?',
      'Cum completez o evaluare a riscului pas cu pas?',
      'Poți oferi un exemplu de proces de validare HACCP?',
      'Care sunt cerințele de calibrare pentru detectoarele de metale?',
      'Ce EIP este necesar pentru procedurile de manipulare a substanțelor chimice?',
    ],
    greeting: 'Agent Standarde Tehnice',
    greetingSubtitle: 'Asistent AI pentru standarde tehnice, proceduri și documentație de conformitate',
    ...
    generateTitle: 'Generator de Principii',
    generateSubtitle: 'Creează documente Principii care leagă Politica BRC de SOP-uri practice',
